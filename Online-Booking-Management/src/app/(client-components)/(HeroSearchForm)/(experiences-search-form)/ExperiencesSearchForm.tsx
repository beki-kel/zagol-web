...
const ExperiencesSearchForm: FC<ExperiencesSearchFormProps> = ({}) => {
  const renderForm = () => {
    return (
      <form className="w-full relative mt-8 flex flex-col md:flex-row  rounded-3xl border-[1px] md:rounded-full shadow-xl dark:shadow-2xl bg-white dark:bg-neutral-800 ">
